...
[![Tests](https://github.com/monurkeskin/jennifer-negotiation-2021/actions/workflows/tests.yml/badge.svg)](https://github.com/monurkeskin/jennifer-negotiation-2021/actions/workflows/tests.yml)
[Paper](https://doi.org/10.1007/978-981-15-5869-6_1) · [Method](METHOD.md) · [Reproduce](REPRODUCIBILITY.md) · [Protocol](docs/protocol.md) · [Contribute](docs/development.md)
...
```bash
git clone https://github.com/monurkeskin/jennifer-negotiation-2021.git
cd jennifer-negotiation-2021
python3 -m venv .venv
